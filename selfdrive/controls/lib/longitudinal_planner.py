...
class LongitudinalPlanner:
  ...
  def update(self, sm):
    ...
    output_a_target, self.output_should_stop, self.output_v_target, self.output_j_target = get_accel_from_plan(
      self.v_desired_trajectory, self.a_desired_trajectory, self.j_desired_trajectory,
