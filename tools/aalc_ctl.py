...
Usage:
  ...
  aalc_ctl.py set responsiveness <0-3>
  aalc_ctl.py set learner <0|1>
  aalc_ctl.py status
"""
...
def main():
  ...
  if cmd == "set":
    ...
    elif what == "responsiveness":
      p.put("AALCResponsiveness", val)
    elif what == "learner":
      p.put("AALCLearner", val)
    else:
      print(HELP)
      return
  ...
  if cmd == "status":
    st = {
      ...
      "AALCResponsiveness": g("AALCResponsiveness", "2"),
      "AALCLearner": g("AALCLearner", "1"),
    }
